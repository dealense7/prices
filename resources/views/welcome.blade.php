...
@section('content')
    ...
    <!--   ვინც გადოსოს ტრაკი იყოს, ისედაც საწყალ 3.5 ევროიან სერვერზეა.   -->
    <p class="my-2 p-3 text-xs font-normal">ნაჩვენებია მხოლოს ის პროდუქტები რომლებიც მინიმუმ 2 მაღაზიაში მაინცაა, თუმცა ცოტა პროდუქტია და ეგეც ცოტათი არეულად. უბრალოდ სატესტო ვერსიაა. მომავალში თუ გადავწყვეტ გაგრძელებას დაემატება მეტი.</p>
@endsection
