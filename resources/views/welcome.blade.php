...
@section('content')
            ...
            <div class="col-span-6 bg-gray-100 h-[280px] flex items-center justify-between relative">
                <div class="ml-4">
                    ...
                    <p class="mt-2 font-normal text-xs text-gray-700">
                        შეადარეთ 500-ზე მეტი პროდუქტი სუპერმარკეტებსა და მაღაზიებში.
                    </p>
                ...
                <div class="top-3 z-10 absolute right-3 flex items-center gap-2">
                    <div class="bg-[#bde6c6] p-1.5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#333" class="bi bi-chevron-left" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0"/>
                        </svg>
                    </div>
                    <div class="bg-[#bde6c6] p-1.5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#333" class="bi bi-chevron-right" viewBox="0 0 16 16">
    ...
    <div class="grid grid-cols-10">
        <div class="col-span-10 bg-white shadow p-3 rounded-[4px]">
            <ul class="font-normal text-xs flex items-center justify-between">
