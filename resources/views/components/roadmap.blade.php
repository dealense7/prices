            ...
            <div class="p-4 md:p-5 space-y-4">
                <ul>
                    ...
                    <li class="p-2 text-xs font-normal my-1 w-full border rounded-[3px]">
                        ...
                        <h4 class="my-2 font-medium">ფუნქციონალი</h4>
                        <p class="text-gray-500">
                            დიზაინის მორგება მობილურისთვის და პლანშეტისთვის, სლაიდერის ამუშავება, მეტი ფილტრის და სტატისტიკის დამატება. ფასების წამოღების გასწორება.
                        </p>
                    </li>
                </ul>
            </div>
