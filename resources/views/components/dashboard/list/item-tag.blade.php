            ...
            <div class="w-full overflow-hidden flex items-center gap-1">
                <template x-if="selectedOptions">
                    <template x-for="selected in selectedOptions">
                                <span :key="selected.id" class="text-xs bg-gray-200 p-1 text-gray-700 flex items-center w-max" x-init="console.log(selected)">
{{--                                    <span x-text="selected.translations[0].name"></span>--}}
